...
description: Guide for using American Fuzzy Lop to find multiple vulnerabilities into an open-source project
tags: ["fuzzing", "open-source", "afl", "gdb", "walkthrough"]
---
...
6. Start the fuzzing for the custom format parsing functionality
