...
publishDate: 5 Nov 2022
description: Walkthrough for using ForensiX to extract information about a Chrome dump
tags: ["forensics", "docker", "walkthrough"]
---
...
2. Download the challenge files with: `for i in {1..6} do; wget https://github.com/8061xjl/ctfarchive-sctf-3.0/blob/main/files/forensics/digging-in-the-dump/AppData.zip.00$i\?raw\=true -o data/AppData.zip.part$i; done`.
